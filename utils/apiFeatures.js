...
class APIFeatures {
  constructor(query, queryString) {
    // query >> "Tour.find()" (data set)
    // queryString >> "req.query" (where clauses)
  ...
  filter() {
    ...
    */
    ...
    /* output...
    { difficulty: 'easy', price: { lte: '2000' } }
    */

    let queryStr = JSON.stringify(queryObj);
    console.log('filter()', 'queryObj (aft/stringify) >> ', queryObj);
    /* output...
    { difficulty: 'easy', price: { lte: '2000' } }
    */
    ...
    */
    ...
    console.log('filter()', 'queryStr(JSON.parse) >> ', JSON.parse(queryStr));
    /* output...
    { difficulty: 'easy', price: { '$lte': '2000' } }
    */
  ...
  sort() {
    if (this.queryString.sort) {
      ...
      console.log('queryString >> ', this.queryString.sort);
